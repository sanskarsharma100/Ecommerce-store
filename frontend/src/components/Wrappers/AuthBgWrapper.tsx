...
export const AuthBgWrapper: FC<Props> = ({ children }) => {
  return (
    <div className="flex h-screen before:absolute before:h-full before:w-full before:bg-primary-100 before:bg-shopBg before:bg-blend-multiply before:content-['']">
